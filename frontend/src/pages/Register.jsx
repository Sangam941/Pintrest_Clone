  ...
  return (
    <div className='w-full h-screen bg-zinc-100 flex justify-center items-center'>
      <div className='w-full shadow-lg bg-white p-8 max-w-md rounded-md'>
        ...
        <h2 className='text-2xl font-semibold text-center '>Register to pintrest</h2>
        ...
        <form className='mt-5' onSubmit={submitHandler}>
          <div>
            ...
            className='common-input' type="name" name="name" id="name" placeholder='Enter your name' required/>
          </div>
          <div>
